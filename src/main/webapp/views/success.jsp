...
var iCurrentSpeed = ${VechileSpeed},
	iTargetSpeed = ${VechileSpeed},
	bDecrement = null,
	job = null;
...
<body align="centre" onload='draw(0);'>
    <canvas id="tutorial" width="440" height="220">Canvas not available.</canvas>
<div class="container">
  <table  class="table table-bordered">
  <tr>
		<td align><b>Your Vehicle Id: </b></td>
		<td>${VechileId}</td>
	</tr>
	<tr>
		<td><b>Your Vehicle Speed: </b></td>
		<td>${VechileSpeed}</td>
	</tr>
	<tr>
		<td><b>Your Vehicle Latitude : </b></td>
		<td>${VechileLt}</td>
	</tr>
	<tr>
		<td><b>Your Vehicle Langitude: </b></td>
		<td>${VechileLg}</td>
	</tr>
  </table>
</div>
...
<script>
function myMap() {
  var myCenter = new google.maps.LatLng(${VechileLt},${VechileLg});
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCaR6rhOUiJbjK22J3BD1BdEqMe5VX0Rr0&callback=myMap"></script>
</body>
</html>